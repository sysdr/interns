...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group alignfull">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group" style="padding-right:0;padding-left:0">
					...
					<h3 class="wp-block-heading has-medium-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Links', 'ctoi' ); ?></h3>
					<!-- /wp:heading -->
					<!-- wp:navigation {"overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"fontSize":"medium","layout":{"type":"flex","orientation":"vertical"},"ariaLabel":"<?php esc_attr_e( 'Links', 'ctoi' ); ?>"} -->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Internships', 'ctoi' ); ?>","url":"/internships/"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'About', 'ctoi' ); ?>","url":"/about/"} /-->
						<!-- wp:navigation-link {"label":"<?php esc_html_e( 'FAQ', 'ctoi' ); ?>","url":"/faq/"} /-->
					<!-- /wp:navigation -->
				</div>
				<!-- /wp:group -->
			</div>
		...
		<div class="wp-block-group alignfull">
			...
			<p class="has-small-font-size"><?php esc_html_e( 'ctoi', 'ctoi' ); ?></p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"fontSize":"small"} -->
			...
			printf(
				...
				esc_html__( 'Designed with %s', 'ctoi' ),
				'WordPress'
			);
			?>
			</p>
